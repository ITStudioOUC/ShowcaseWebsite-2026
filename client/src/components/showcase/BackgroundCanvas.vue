...
const auroraArcs: AuroraArc[] = [
  ...
  { worldY: 340, amp: 35, freq: 0.0016, slantAngle: -0.55, avgH: 220, hVar: 130, density: isMobile ? 10 : 5, width: 4.5, foldCount: 3, foldIntensity: 1.5, cBase: { r: 255, g: 100, b: 80 }, cMid: { r: 220, g: 60, b: 50 }, cTop: { r: 160, g: 30, b: 40 }, opacity: 0.55, speed: 0.0045, phaseShift: 2.5 },
  { worldY: 600, amp: 50, freq: 0.0022, slantAngle: 0.65, avgH: 260, hVar: 160, density: isMobile ? 14 : 7, width: 4, foldCount: 4, foldIntensity: 1.3, cBase: { r: 255, g: 140, b: 130 }, cMid: { r: 240, g: 100, b: 140 }, cTop: { r: 180, g: 60, b: 120 }, opacity: 0.6, speed: 0.007, phaseShift: 5.0 },
