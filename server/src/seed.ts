...
(async () => {
  ...
  const orgLeadersData = [
    ...
    ['系统维护部', '部长', '陈运维', 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&q=80', 'K8s / 网络安全', 6],
    ['宣传部', '部长', '周设计', 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=200&q=80', 'Figma / 视觉传达', 7],
    ['程序部', '部长', '吴后端', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80', 'Java / Go', 8],
    ['Web部', '部长', '郑前端', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&q=80', 'React / Next.js', 9],
    ['游戏部', '部长', '马游戏', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80', 'Unity / C#', 10],
    ['APP部', '部长', '胡移动', 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&q=80', 'Flutter / Android', 11],
    ['iOS部', '部长', '林苹果', 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=200&q=80', 'Swift / SwiftUI', 12],
    ['鸿蒙部', '部长', '郭鸿蒙', 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=200&q=80', 'HarmonyOS / ArkTS', 13],
  ];
